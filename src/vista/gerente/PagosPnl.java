 ...
 * @author Johnny
 */
public class PagosPnl extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        cbOdenarPor.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Nombre", "Fecha", "Salario" }));

        cbOpciones.setFont(new java.awt.Font("Arial", 0, 16)); // NOI18N
        cbOpciones.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Adelanto", "Pagos por mes", "Todos los pagos", "Pagos por empleado", "Pagos pendientes", "Pagos realizados" }));
        ...
        tblPagos.setSelectionBackground(new java.awt.Color(125, 151, 171));
