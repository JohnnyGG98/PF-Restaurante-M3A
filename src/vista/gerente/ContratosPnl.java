 ...
 * @author Johnny
 */
public class ContratosPnl extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        cbOdenarPor.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Nombre", "Fecha", "Jornada", "Salario" }));

        cbOpciones.setFont(new java.awt.Font("Arial", 0, 16)); // NOI18N
        cbOpciones.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Historial salario", "Contratos terminados", "Pagos", "Asistencia", "Terminar contrato" }));
        ...
        tblContratos.setSelectionBackground(new java.awt.Color(125, 151, 171));
        jScrollPane1.setViewportView(tblContratos);

        btnTerminar.setBackground(new java.awt.Color(60, 99, 130));
        btnTerminar.setFont(new java.awt.Font("Arial", 0, 16)); // NOI18N
