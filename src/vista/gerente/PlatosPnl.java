 ...
 * @author Johnny
 */
public class PlatosPnl extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        cbOdenarPor.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Nombre", "Precio", "Calificacion" }));

        cbOpciones.setFont(new java.awt.Font("Arial", 0, 16)); // NOI18N
        cbOpciones.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Ventas" }));
        ...
        tblPlatos.setSelectionBackground(new java.awt.Color(125, 151, 171));
